...
describe Game do
  it 'Test the properties' do
    game = Game.new('2000-05-05', '2012-05-05')
  ...
  it 'Test move_to_archived method: last_played_at is older than 2 years' do
    game = Game.new('2022-05-05', '2012-01-01')
